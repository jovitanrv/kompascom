        ...
        <div class="col-sm-10 col-sm-offset-1">
          ...
          <div id="signup-box" class="signup-box widget-box no-border visible">
            <div class="widget-main">
              ...
              <form method="POST" action="<?= site_url('C_login'); ?>" accept-charset="UTF-8">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" style="width: 100px; border-radius: 0px;">Login</button>
                    <input type="checkbox" style="margin-right:5px; margin-left: 100px;">Ingatkan saya
                </div>
              </form>
            </div>
          </div>
          <div class="bawah">
            <a style="float:left; margin-left:8px;" href="<?= site_url('C_frgt_pass');?>">Lupa password ?</a>
            <a style="float:right; margin-right:8px;" href="<?= site_url('C_registration');?>">Daftar</a>
          </div>
          <div class="satu">
